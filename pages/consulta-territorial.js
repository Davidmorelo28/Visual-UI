...
document.getElementById("departamentoSelector");

const listaDepartamentos =
document.getElementById("listaDepartamentos");

const modalDepartamentos =
document.getElementById("modalDepartamentos");
...
departamentoSelector.addEventListener("click",()=>{
    ...
    Object.keys(datos).forEach(departamento=>{
        ...
        item.onclick = ()=>{
            ...
            departamentoSelector.innerHTML =
            departamento;

            selectorMunicipio.innerHTML =
            "Seleccione un municipio";

            modalDepartamentos.style.display =
            "none";
